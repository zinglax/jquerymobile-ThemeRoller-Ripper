...
colorgentwo_theme_dir = os.path.join(working_directory, "colorgentwo-Theme")
...
def color_replace(input_dir, output_dir=temp_theme_dir):
    ...
    for tag,color in get_jinja_fields_and_colors(json_file=colorgentwo_json).iteritems():
        #pretty((tag, color))
